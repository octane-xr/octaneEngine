...
namespace Octane
{
    ...
    struct EventListener
    {
        ...
        OCTANE_INLINE EventListener(CallbackFn&& callback, uint32_t listnrid):
    ...
    struct EventDispatcher
    {
        ...
        OCTANE_INLINE void EraseListener(uint32_t listnrid)
        {
